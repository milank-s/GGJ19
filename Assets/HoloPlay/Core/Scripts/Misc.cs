...
namespace HoloPlay
{
    public static class Misc
    {
        ...
        //* debug */
        public readonly static string debugText = "[HoloPlay] ";
        ...
        public static bool GetNextFilename(string path, string filename, string extension, out string fullName, out string fullPath)
        {
            ...
            {
                Debug.Log(debugText + "Invalid path");
                fullName = filename;
                fullPath = path;
                return false;
            }
        ...
        /// </summary>
        public readonly static Color gizmoColor = Color.HSVToRGB(0.35f, 1, 1);
        public readonly static Color gizmoColor0 = Color.HSVToRGB(0.5f, 1, 1);
        public readonly static Color gizmoColor1 = Color.HSVToRGB(0.675f, 0.5f, 1);
        public readonly static Color gizmoLogoColor = Color.HSVToRGB(0.8f, 0.8f, 1);
